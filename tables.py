...
class Tables():
    def __init__(self, tabName='Results.xlsx'):
        ...
        self.text = {'Вид отклонения':
        ['Плечи', 'Таз', 'Локти', 'Колени', 'Шея', 'Осанка', 'Голень/Стопа', 'Руки вперед', 'Руки в стороны', 'Руки подняты'],
    ...
    def handToUpR(self, upAng):
        self.text['Показания спедери/п.бок'][9] = upAng - 90
